...
let TareaModel = (() => {
    ...
    var TareaModel = _classThis = class extends _classSuper {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "TareaModel");
    (() => {
        var _a;
        ...
        TareaModel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return TareaModel = _classThis;
})();
exports.default = TareaModel;
